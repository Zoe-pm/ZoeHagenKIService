...
const products = [
  ...
  },
  {
    ...
    features: ["Menschliche Präsenz", "Vertrauensaufbau", "Starker Eindruck", "Schnelle, intelligente, freundliche Antworten auf Fragen Ihrer Kunden", "Personalengpass ade", "Jederzeit erreichbar"],
